;;; publish.el --- Export readme_src.org to HTML with oat.ink  -*- lexical-binding: t; -*-
...
;; Override toc:nil from the file — the sidebar needs a TOC
(setq org-export-with-toc 2)

(with-current-buffer (find-file-noselect "readme_src.org")
